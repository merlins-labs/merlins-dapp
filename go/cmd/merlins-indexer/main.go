...
import (
	...
	"github.com/merlins-labs/merlins-dapp/go/internal/indexerhandler"
	"github.com/merlins-labs/merlins-dapp/go/pkg/networks"
	"github.com/merlins-labs/merlins-dapp/go/pkg/pricespb"
	"github.com/merlins-labs/merlins-dapp/go/pkg/quests"
	"github.com/merlins-labs/merlins-dapp/go/pkg/tmws"
...
func main() {
	...
	var (
		...
		minterCodeIDs               = fs.String("merlins-minter-code-ids", "", "code ids of merlins minter contracts")
		...
		networkID                   = fs.String("indexer-network-id", "merlins", "network id to index")
	)
	...
	replayInfos := []ReplayInfo{
		/*{
			StartHeight:       0,
			FinalHeight:       1154235,
			WebsocketEndpoint: "wss://merlins.65.108.73.219.nip.io/rpc/websocket",
		},*/
		{
			//StartHeight:       1154236,
			StartHeight:       0,
