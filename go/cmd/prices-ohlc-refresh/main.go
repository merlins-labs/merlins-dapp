...
import (
	...
	"github.com/merlins-labs/merlins-dapp/go/internal/pgutil"
	"github.com/merlins-labs/merlins-dapp/go/internal/urlutil"
	"github.com/merlins-labs/merlins-dapp/go/pkg/coingeckoprices"
	"github.com/merlins-labs/merlins-dapp/go/pkg/prices_db"
...
func main() {
	...
	var (
		coinIds = fs.String("coin-ids", "merlins,cosmos", "coingecko ids of coins to refresh")
