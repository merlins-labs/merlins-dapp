...
import { MerlinsSquadStakingClient } from "../contracts-clients/merlins-squad-staking/MerlinsSquadStaking.client";
import {
  GetConfigResponse,
  Nft as SquadStakeNFT,
} from "../contracts-clients/merlins-squad-staking/MerlinsSquadStaking.types";
import {
  getCosmosNetwork,
...
export const squadWithdrawSeason1 = async (userId: string | undefined) => {
  ...
  const client = new MerlinsSquadStakingClient(
    signingClient,
    userAddress,
    contractAddress
  );
