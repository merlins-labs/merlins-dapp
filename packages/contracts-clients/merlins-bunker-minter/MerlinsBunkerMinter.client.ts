...
import { Uint128, ConfigResponse, Addr, Config, CurrentSupplyResponse, ExecuteMsg, Metadata, Attribute, InstantiateMsg, IsWhitelistedResponse, MigrateMsg, QueryMsg, TokenRequestByIndexResponse, TokenRequestsCountResponse, WhitelistSizeResponse } from "./MerlinsBunkerMinter.types";
export interface MerlinsBunkerMinterReadOnlyInterface {
...
export class MerlinsBunkerMinterQueryClient implements MerlinsBunkerMinterReadOnlyInterface {
...
export interface MerlinsBunkerMinterInterface extends MerlinsBunkerMinterReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: ({
    mintMax,
...
export class MerlinsBunkerMinterClient extends MerlinsBunkerMinterQueryClient implements MerlinsBunkerMinterInterface {
