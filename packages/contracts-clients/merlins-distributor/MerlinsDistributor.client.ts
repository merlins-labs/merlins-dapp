...
import { Addr, ConfigResponse, Config, Cw721HookMsg, ExecuteMsg, Uint128, RewardInfo, InstantiateMsg, QueryMsg, ReportAmountResponse, TotalClaimableResponse, UserClaimableResponse } from "./MerlinsDistributor.types";
export interface MerlinsDistributorReadOnlyInterface {
...
export class MerlinsDistributorQueryClient implements MerlinsDistributorReadOnlyInterface {
...
export interface MerlinsDistributorInterface extends MerlinsDistributorReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: ({
    owner
...
export class MerlinsDistributorClient extends MerlinsDistributorQueryClient implements MerlinsDistributorInterface {
