...
export interface MerlinsSocialFeedReadOnlyInterface {
...
export class MerlinsSocialFeedQueryClient
  implements MerlinsSocialFeedReadOnlyInterface
{
...
export interface MerlinsSocialFeedInterface
  extends MerlinsSocialFeedReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: (
    {
...
export class MerlinsSocialFeedClient
  extends MerlinsSocialFeedQueryClient
  implements MerlinsSocialFeedInterface
{
