...
export class MerlinsBreedingQueryClient implements MerlinsBreedingReadOnlyInterface {
...
export interface MerlinsBreedingInterface extends MerlinsBreedingReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: ({
    breedCountLimit,
...
export class MerlinsBreedingClient extends MerlinsBreedingQueryClient implements MerlinsBreedingInterface {
