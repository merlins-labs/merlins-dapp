...
import { AddressOfResponse, AdminAddressResponse, Expiration, Timestamp, Uint64, Logo, EmbeddedLogo, Binary, AllNftInfoResponse, OwnerOfResponse, Approval, NftInfoResponseForMetadata, Metadata, AllOperatorsResponse, AllTokensResponse, AuthorizedCharactersResponse, BaseTokensResponse, Uint128, ContractInfoResponse, ExecuteMsg, SetAuthorizedCharactersMsg, UpdateSupportedDomainMsg, UpdateMintingFeesMsg, UpdateMetadataMsg, MintMsgForMetadata, GetFullPathResponse, GetParentIdResponse, GetParentInfoResponse, GetPathResponse, InstantiateMsg, IsContractResponse, IsSupportedDomainResponse, ListInfoByAliasResponse, UserInfo, ListUserInfoResponse, MigrateMsg, MintPriceResponse, MinterResponse, MintingFeesResponse, NftInfoResponse, NumTokensResponse, OperatorsResponse, PathsForTokenResponse, PathsResponse, PrimaryAliasResponse, QueryMsg, TokensResponse } from "./MerlinsNameService.types";
export interface MerlinsNameServiceReadOnlyInterface {
...
export class MerlinsNameServiceQueryClient implements MerlinsNameServiceReadOnlyInterface {
...
export interface MerlinsNameServiceInterface extends MerlinsNameServiceReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class MerlinsNameServiceClient extends MerlinsNameServiceQueryClient implements MerlinsNameServiceInterface {
