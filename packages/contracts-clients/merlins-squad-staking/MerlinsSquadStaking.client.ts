...
import { ExecuteMsg, Addr, Nft, GetConfigResponse, GetSquadResponse, Squad, GetUserSquadCountResponse, InstantiateMsg, IsCollectionWhitelistedResponse, QueryMsg } from "./MerlinsSquadStaking.types";
export interface MerlinsSquadStakingReadOnlyInterface {
...
export class MerlinsSquadStakingQueryClient implements MerlinsSquadStakingReadOnlyInterface {
...
export interface MerlinsSquadStakingInterface extends MerlinsSquadStakingReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: ({
    owner,
...
export class MerlinsSquadStakingClient extends MerlinsSquadStakingQueryClient implements MerlinsSquadStakingInterface {
