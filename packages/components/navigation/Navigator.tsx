...
import { TNSHomeScreen } from "../../screens/MerlinsNameService/TNSHomeScreen";
...
export const screenTitle = (title: string) => "Merlins - " + title;
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        options={{ header: () => null, title: "Merlins" }}
      />
      <Stack.Screen
        name="Feed"
