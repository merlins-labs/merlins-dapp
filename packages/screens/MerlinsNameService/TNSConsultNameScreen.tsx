...
import { TNSSendFundsModal } from "../../components/modals/merlinsNameService/TNSSendFundsModal";
import { NameData } from "../../components/merlinsNameService/NameData";
import { NameNFT } from "../../components/merlinsNameService/NameNFT";
        ...
        <SecondaryButton
          ...
          onPress={async () => {
            try {
              ...
              const client = new MerlinsNameServiceClient(
