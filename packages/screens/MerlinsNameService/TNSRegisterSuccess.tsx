  ...
  const SOCIAL_BUTTONS = [
    {
      ...
      iconSvg: twitterSVG,
      onPress: () => {
        const message = `I just acquired my '${tokenId}' handle on @MerlinsNetwork, which will allow me to use the decentralized Social Hub! ⛩️
Alpha v0.1 is live 🔥
${window.location.origin}/user/fury-${selectedWallet?.address}
#Merlins #Alpha #SocialHub #Cosmos #IBCGang`;
        Linking.openURL(
